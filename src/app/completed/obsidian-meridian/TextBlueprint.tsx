...
const FONT: Record<string, Glyph> = {
  ...
  V: ["CMMMC", "CMMMC", "CMMMC", "CMMMC", "CMMMC", "MCMCM", "MMCMM"],
  W: ["CMMMMC", "CMMMMC", "CMMMMC", "CMMMMC", "CMCCMC", "CCMMCC", "CMMMMC"],
  X: ["CMMMC", "CMMMC", "MCMCM", "MMCMM", "MCMCM", "CMMMC", "CMMMC"],
  Y: ["CMMMC", "CMMMC", "MCMCM", "MMCMM", "MMCMM", "MMCMM", "MMCMM"],
  Z: ["CCCCC", "MMMMC", "MMMCM", "MMCMM", "MCMMM", "CMMMM", "CCCCC"],
